 ...
 * - toolbar.css
 */
function sinopec_tao_css_alter(&$css) {
  $exclude = array(
 ...
 */
function sinopec_tao_preprocess_html(&$vars) {
  $vars['classes_array'][] = 'tao';

  // Add IE from theme file.
  $sinopec_tao_path = drupal_get_path('theme', 'tao');
  $info = drupal_parse_info_file($sinopec_tao_path.'/tao.info');
  $ie = $info['stylesheets']['ie'];
  foreach ($ie as $key => $value) {
    drupal_add_css(
      $sinopec_tao_path.'/'.$value,
      array(
        'browsers' => array(
          'IE' => $key,
          '!IE' => FALSE
 ...
 */
function sinopec_tao_preprocess_page(&$vars) {
 ...
 */
function sinopec_tao_preprocess_block(&$vars) {
  $vars['hook'] = 'block';
 ...
 */
function sinopec_tao_preprocess_node(&$vars) {
  $vars['hook'] = 'node';
 ...
 */
function sinopec_tao_preprocess_comment(&$vars) {
  $vars['hook'] = 'comment';
 ...
 */
function sinopec_tao_preprocess_fieldset(&$vars) {
 ...
 */
function sinopec_tao_preprocess_field(&$vars) {
 ...
 */
function sinopec_tao_textarea($vars) {
  $element = $vars['element'];
 ...
 */
function sinopec_tao_pager($vars) {
  $tags = $vars['tags'];
  $element = $vars['element'];
 ...
 */
function sinopec_tao_pager_list($vars) {
  $tags = $vars['tags'];
  $element = $vars['element'];
  $parameters = $vars['parameters'];
  $quantity = $vars['quantity'];
 ...
 */
function sinopec_tao_pager_link($vars) {
  $text = $vars['text'];
 ...
 */
function sinopec_tao_views_mini_pager($vars) {
  $tags = $vars['tags'];
  $quantity = $vars['quantity'];
  $element = $vars['element'];
  $parameters = $vars['parameters'];
