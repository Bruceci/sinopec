 ...
 *   The form state.
 */
function sinopec_business_form_system_theme_settings_alter(&$form, &$form_state) {
    ...
    $form['mtt_settings']['tabs']['basic_settings']['breadcrumb_display'] = array(
        ...
        '#default_value' => theme_get_setting('breadcrumb_display','sinopec_business'),
    );
    ...
    $form['mtt_settings']['tabs']['basic_settings']['scrolltop_display'] = array(
        ...
        '#default_value' => theme_get_setting('scrolltop_display', 'sinopec_business'),
        '#collapsible' => TRUE,
        '#collapsed' => TRUE,
    );
    ...
    $form['mtt_settings']['tabs']['ie8_support']['responsive_respond'] = array(
        ...
        '#default_value' => theme_get_setting('responsive_respond','sinopec_business'),
