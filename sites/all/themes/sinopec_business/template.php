 ...
 * Page alter.
 */
function sinopec_business_page_alter($page) {
 ...
 */
function sinopec_business_preprocess_html(&$variables) {
	/**
	 * Add IE8 Support
	 */
	...
	*/
    ...
    if (theme_get_setting('bootstrap_css_cdn', 'sinopec_business')) {
        $cdn = '//maxcdn.bootstrapcdn.com/bootstrap/' . theme_get_setting('bootstrap_css_cdn', 'sinopec_business')  . '/css/bootstrap.min.css';
        drupal_add_css($cdn, array('type' => 'external'));
    }
    
    if (theme_get_setting('bootstrap_js_cdn', 'sinopec_business')) {
        $cdn = '//maxcdn.bootstrapcdn.com/bootstrap/' . theme_get_setting('bootstrap_js_cdn', 'sinopec_business')  . '/js/bootstrap.min.js';
	...
	*/
	if (theme_get_setting('scrolltop_display', 'sinopec_business')) {
 ...
 */
function sinopec_business_process_html(&$vars) {
 ...
 */
function sinopec_business_preprocess_page(&$vars) {
 ...
 */
function sinopec_business_process_page(&$variables) {
  // Hook into color.module.
  if (module_exists('color')) {
 ...
 */
function sinopec_business_preprocess_block(&$variables) {
 ...
 */
function sinopec_business_breadcrumb($variables) {
 ...
 */
function sinopec_business_form_alter(&$form, &$form_state, $form_id) {
